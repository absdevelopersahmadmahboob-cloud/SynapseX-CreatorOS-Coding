...
| `CODE_RUNNER_URL` | Isolated verification-runner endpoint | Required before real user-code execution |
| `CODE_RUNNER_TOKEN` | Long random token shared with the isolated runner | Required with `CODE_RUNNER_URL` |
